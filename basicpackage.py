...
print (''' \033[95m
+--------------------------------------+
| This Tool Install AToZ Basic Packages  |
+--------------------------------------+
| Coded By Alone Hacker | version : 1.1  |
+--------------------------------------+''')
...
print ("                                            ")
choice = input("\033[93mDo You Want to Install AToZ Packages [y/n] : ")
...
def slowprint(s):
    for c in s + '\n' :
        ...
        time.sleep(8. / 100)
print("\033[95m+-------------------------------------------------+")
slowprint('''\033[95m|             Welcome To Hackers Worlds            |
